...
void IB_Run_All_Test_Data( ofstream &file )
{
	...
	*/
	sprintf( vidname, "C:/Users/Ian Beatty-Orr/Documents/Y5 Eng/5E1/Recordings/M4H00750.MP4.AVI" );
	sprintf( annotatename, "C:/Users/Ian Beatty-Orr/Documents/Y5 Eng/5E1/Recordings/Annotations/IB_A_750" );
	//cout << endl << "CALLING NEXT VIDIEO: " << num << endl << vidname << endl << annotatename << endl << endl;
	IB_Backpack_Detection( vidname, annotatename, result );
...
void IB_Backpack_Detection( char vidname[100], char annotatename[100], prResults &results )
 {
   ...
   if( capture )
   {
     while( true )
     {
		...
		if( true || wholeROI.empty() )	{ // || frameCount < 223 )	{
			int key = cvWaitKey(0);
			continue;
		}
