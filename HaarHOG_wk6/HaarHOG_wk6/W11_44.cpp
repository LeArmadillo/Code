...
int main( int argc, const char** argv )
 {
	...
	CvCapture* capture;
	char filename[100];
	sprintf(filename, "C:/Users/Ian Beatty-Orr/Documents/Y5 Eng/5E1/Recordings/M4H00740.MP4.AVI");
   ...
   if( capture )
   {
     while( true )
     {
		...
		IB_trackObject( false, trackingLocation, wholeImage, trackingArray, frameCount );
